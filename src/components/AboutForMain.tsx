    ...
    return (
      <div className="relative isolate overflow-hidden bg-white py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8 flex flex-col items-center">
          <h2 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">TecoStudio 帝咕团队</h2>
          <img
            src="https://photo.jianyuelab.cc/_data/i/upload/2023/06/12/20230612192916-50ebcf4d-me.png"
            alt=""
            className="mt-10 w-full md:w-auto object-cover object-right md:object-center opacity-70"
          />
          <p className="mt-10 text-lg leading-8 text-gray-900 max-w-2xl text-center">
